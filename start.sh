...
docker run --gpus all --ipc=host -p 5000:5000 -d -v $(pwd)/detect.py:/usr/src/app/detect.py -v $(pwd)/cut_video.py:/usr/src/app/cut_video.py -v $(pwd)/app.py:/usr/src/app/app.py --name drone drone-docker
